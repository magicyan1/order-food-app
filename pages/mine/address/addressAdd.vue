	...
	<view class="container">
		<view class="content">
			<form class="content-son" @submit="sure" action="">
				...
				<view class="bottom">
					<button class="operation"  form-type="submit" style="background-color: #f77214;">
						保存</button>
				</view>
			</form>
		</view>
...
<script setup>
	...
	// 	addressCenter.value=JSON.parse(decodeURIComponent(option.item))
	// 	addressForm.value=addressCenter.value
	// 	uni.getStorage({
	// 		key:"address",
	...
	let sure=function(e){
		...
		// if(state.value===1){
		// 	addressAll[addressForm.value.id-1]=addressForm.value;
		// 	uni.setStorageSync('address',addressAll)
		// }
		// else{
		// 	addressCenter.value=addressForm.value
		// 	addressAll.push(addressCenter.value)
		// 	uni.setStorageSync('address',addressAll)
		// }
